    ...
    <Container>
      ...
      <Row className='whiteBackground'>
        <Col>
          ...
          <p>After the Northwestern program, David worked at <a href='https://www.thedifferenceengine.io/' target='_blank'>The Difference Engine</a>(TDE). At TDE, David was assigned to a project called "Women in Comedy", a social media site for aspiring and professional female comedians to connect with one another. The orginal site was built in WordPress, however, the client wanted something different, so the site was rebuilt from scratch. The technologies that were used on this project were: ReactJS, Ruby on Rails, Redux, Heroku, Bootstrap, Docker, and PostGreSQL.</p>
          <br/>
