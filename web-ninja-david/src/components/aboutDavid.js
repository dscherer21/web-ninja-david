    ...
    <Container>
      ...
      <Row className='whiteBackground'>
        <Col>
          ...
          <p>After the Northwestern program, David worked at <a href='https://www.thedifferenceengine.io/' target='_blank'>The Difference Engine</a>(TDE). At TDE, David was assigned to a project called Women in Comedy, a social media site for women that are or want to be comedians and want to connect with like-minded individuals. The orginal site was built in WordPress, but the client wanted something different, so the site was rebuilt from scratch. The technologies that were used on this project were: ReactJS, Ruby on Rails, Redux, Heroku, Docker, and PostGreSQL.</p>
          <br/>
